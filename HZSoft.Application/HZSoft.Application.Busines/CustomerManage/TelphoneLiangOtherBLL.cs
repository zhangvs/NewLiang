...
namespace HZSoft.Application.Busines.CustomerManage
{
    ...
    /// 描 述：代售靓号库
    /// </summary>
    public class TelphoneLiangOtherBLL
    {
        private TelphoneLiangOtherIService service = new TelphoneLiangOtherService();
        ...
        public string UpsForm(string upTelphones)
        {
            try
            {
               return service.UpsForm(upTelphones);
            }
            catch (Exception)
            {
                throw;
        ...
        public void DownsForm(string downTelphones)
        {
            try
            {
                service.DownsForm(downTelphones);
            }
            catch (Exception)
            {
                throw;
