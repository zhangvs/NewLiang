var commonCheckFill = {
    ...
    CustCheck: {
        ...
        checkReceiverName: function (receiverName) {
            ...
            if (commonCheckFill.chineseLen($.trim(receiverName)) < 2) {
                commonCheckFill.error('apply-name', '姓名必须至少包含2个汉字');
                return false;
            }
        ...
        checkName: function (receiverName) {
            ...
            if (commonCheckFill.chineseLen($.trim(receiverName)) < 2) {
                commonCheckFill.error('apply-name-receiver', '姓名必须至少包含2个汉字');
                return false;
            }
            if (commonCheckFill.checkScript(receiverName)) {
    ...
    CustViceCheck: {
        ...
        checkReceiverName: function (errClass, receiverName) {
            ...
            if (commonCheckFill.chineseLen($.trim(receiverName)) < 2) {
                commonCheckFill.viceError(errClass, '姓名必须至少包含2个汉字');
                return false;
            }
            if (commonCheckFill.checkScript(receiverName)) {
