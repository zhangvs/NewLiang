                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (resultH5.return_code == "SUCCESS")
                        {
                            ...
                            //var returnUrl = Config.GetValue("Domain2") + "/webapp/xdd/paymentFinish/" + ordersEntity.Id;
