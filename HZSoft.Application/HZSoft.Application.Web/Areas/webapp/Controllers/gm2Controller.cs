...
{
    /// <summary>
    /// 广州头条：先跳转到wl034.szlwwhcm.top:8062，
    /// 再跳转到 shop.jnlxsm.net
    /// </summary>
    public class gm2Controller : Controller
    {
            ...
            if (!string.IsNullOrEmpty(organizeId))
            {
                ...
                if (!string.IsNullOrEmpty(organize.OrganizeId))
                {
                    ...
                    foreach (var item in entityList)
                    {
                        ...
                        styleStr +=
                        $" <li> " +
                        $"    <a href='https://shop.jnlxsm.net/webapp/gm2/mobileinfo/{item.TelphoneID}?host={host}'>" +//跳转到135服务器详情页面
            ...
            try
            {
                ...
                if (payType == "支付宝")
                {
                    try
                    {
                        ...
                        model.QuitUrl = "https://wl034.szlwwhcm.top:8062/webapp/gm2/index";// 支付中途退出返回商户网站地址
                       ...
                       TenPayV3Type.NATIVE,
                        ...
                        if (result.return_code == "SUCCESS")
                        {
                            H5PayData h5PayData = new H5PayData()
                            {
                                ...
                                wx_query_href = "https://shop.jnlxsm.net/webapp/gm2/queryWx/" + ordersEntity.Id,
                                wx_query_over = "https://shop.jnlxsm.net/webapp/gm2/paymentFinish/" + ordersEntity.Id
                            };
...
Request.UserHostAddress, tenPayV3Info.TenPayV3Notify, TenPayV3Type.JSAPI, openId, tenPayV3Info.Key, nonceStr);
            ...
            if (result.return_code == "SUCCESS")
            {
                WFTWxModel jsApiPayData = new WFTWxModel()
                {
                    ...
                    callback_url = "https://shop.jnlxsm.net/webapp/gm2/paymentFinish/" + ordersEntity.Id
                };
