...
namespace HZSoft.Application.Web.Areas.CustomerManage.Controllers
{
    ...
    public class TelphoneLiangController : MvcControllerBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult TelphoneLiangDelete()
        {
            return View();
        }
        ...
        [HttpPost]
        public ActionResult TelphoneLiangDelete(HttpPostedFileBase filebase)
        {
            HttpPostedFileBase file = Request.Files["files"];
            string FileName;
            string savePath;
            ...
            //引用事务机制，出错时，事物回滚
            ViewBag.error = telphoneliangbll.BatchDeleteEntity(dtSource);
