...
function creatReq() {
	...
	if (req) {
		...
		// 异步请求发送
 		var para = "?link=" + escape(link) + "&oldlink=" + escape(oldlink) + "&title=" + escape(titleName) + "&sys=" + getSysInfo() + "&s=" + screen + "&b=" + GetBrowserType() + " " + GetBrowserVersion() + "&k=" + GetKeyword(oldlink)
