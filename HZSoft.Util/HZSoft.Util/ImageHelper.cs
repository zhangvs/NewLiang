...
namespace HZSoft.Util
{
    ...
    public class ImageHelper
    {
        ...
        /// 水印图片路径(为""表示不使用水印)
        /// 是否判断横图
        public static void ZoomAuto(FileStream fromFile, string savePath, System.Double targetWidth, System.Double targetHeight, string watermarkText, string watermarkImage,bool Rotate)
        {
            //创建目录
            ...
            if (Rotate)
            {
                ...
                //}
                //如果是横图，顺时针旋转90度
                if (initImage.Height < initImage.Width)
                {
